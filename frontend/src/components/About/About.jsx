			...
			>
				...
				<Box w={{ base: "full", md: "50%" }}>
					...
					>
						...
						being moved to use them read them - OR - even be inspired by them. I
						deeply believe in design and development and not just as a service
						provider, but as a partner in the overall business and development
						process of the final product. It is critical to the success of any
						real company to have a website welcoming their clients and that is
						WHAT I'M HERE FOR.
					</Text>
				</Box>
			</Flex>
